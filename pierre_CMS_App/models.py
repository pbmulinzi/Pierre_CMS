...
class Customer(models.Model): 
    ...
    status = models.CharField(max_length=200, choices=STATUS, default='Active', null=True)
...
class Order(models.Model):
    ...
    order_status = models.CharField(max_length=200, choices=ORDER_STATUS, null=True)
